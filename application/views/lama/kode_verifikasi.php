...
?>
    ...
    <section style="padding-top:20px">
        ...
        <div class="text-center">
                <img src="<?= base_url('assets/logo-rspau.png');?>" width="60vw" style="padding-top:15px; margin-bottom:-15px;" />
                <h3 class="stroke">WHISTLE BLOWING SYSTEM</h3>
              <!--   <h3 class="stroke2">(WHISTLE BLOWING SYSTEM)</h3> -->
                <h4 class="stroke1">RSPAU dr. S. HARDJOLUKITO</h4>
            </div>
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation">
                                    <a href="#identitas" data-toggle="tab">
                                        <i class="material-icons">contacts</i> ISI IDENTITAS <i class="material-icons">keyboard_arrow_right</i>
                                    </a>
                                </li>
                                <li role="presentation"  class="active">
                                    <a href="#profile" data-toggle="tab">
                                        <i class="material-icons">email</i> VERIFIKASI EMAIL <i class="material-icons">keyboard_arrow_right</i>
                                    </a>
                                </li>
                                <li role="presentation">
                                    <a href="javascript:void(0);" data-toggle="tab">
                                        <i class="material-icons">edit</i> TULIS PENGADUAN
                                    </a>
                                </li>
                           ...
                           <?php foreach($data as $row){?>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nik" class="form-control" placeholder="" value="<?= $row['nik']; ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="nama" class="form-control" placeholder="" value="<?= $row['nama']; ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" name="no_hp" class="form-control" placeholder="" value="<?= $row['no_hp']; ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-7 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="email" name="email" class="form-control" placeholder="" value="<?= $row['email']; ?>" disabled>
                                            </div>
                                        </div>
                                    </div>
                                   ...
                                   <div class="row row-centered">
                                    ...
                                    <div class="col-lg-4 col-md-10 col-sm-8 col-xs-7 col-centered">
                                        <div class="form-group form-group-lg">
                                            ...
                                            <input type="text" name="confkode" id="centeralign-textbox" maxlength="10" class="form-control" placeholder="" value="<?= $kode; ?>" required>
